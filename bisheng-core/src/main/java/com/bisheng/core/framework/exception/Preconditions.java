...
public final class Preconditions {
    ...
    public static <T> T checkCast(
        ...
        if (!clazz.isInstance(obj)) {
            throw new BusinessException(format("expect %s but is %s", clazz, obj.getClass()));
        }
    ...
    public static <T> T checkCast(
        ...
        if (!clazz.isInstance(obj)) {
            throw new BusinessException(format(errorMessage, errorMessageArgs));
        }
        return clazz.cast(obj);
    }
     ...
     * @throws BusinessException if {@code expression} is false
     * @throws BusinessException if the check fails and either {@code
