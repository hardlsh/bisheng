	...
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>展馆管理-修改展馆
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-toolbar">
					...
					<form id='filter_form' href="##" method="post">
						<!-- 隐藏域 -->
						<input type="hidden" name="exhibitId" value="${exhibit.exhibitId }">
						<div class="row" style="margin-bottom: 10px;">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 col-xs-12">展馆名称<span class="required"> * </span></label>
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="exhibitName" class="form-control" id="exhibitName" 
										value="${exhibit.exhibitName }" placeholder="展馆名称唯一"/>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="exhibitCode" class="form-control" id="exhibitCode" 
										value="${exhibit.exhibitCode }" placeholder="展馆code唯一"/>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="phone" class="form-control" id="phone" value="${exhibit.phone }"/>
									</div>
								</div>
							</div>
						</div>	
						<div class="row" style="margin-bottom: 10px;">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
		                                <select class="bs-select form-control input-inline input-sm" id="provinceId">
											...
											<c:forEach items="${provinces}" var="item">
												<c:choose>
													<c:when test="${exhibit.parentId == item.areaId}">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										...
										<input type="hidden" id="defaultCityId" value="${exhibit.areaId}"/>
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 col-xs-12">展馆状态<span class="required"> * </span></label>
									<div class="col-md-8 col-sm-8 col-xs-12">
										<hz:multipleSelect name="exhibitStatus" id="status"  dictCode="BOOTH_STATUS" value="${exhibit.status}"  
						...
						<div class="row" style="margin-bottom: 10px;">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="startTime" class="form-control" id="startTime" value="${exhibit.startTime}"/>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<input type="text" name="endTime" class="form-control" id="endTime" value="${exhibit.endTime}"/>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-8 col-sm-8 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-10 col-xs-12">
										<input type="text" name="address" class="form-control" id="address" value="${exhibit.address}"/>
									</div>
								</div>
							</div>
						</div>
						<div class="row" style="margin-bottom: 10px;">
							<div class="col-md-8 col-sm-8 col-xs-12">
								<div class="form-group">
									...
									<div class="col-md-10 col-sm-10 col-xs-12">
										<textarea name="remark" class="form-control" maxlength="225" rows="2">${exhibit.remark}</textarea>
									</div>
								</div>
							</div>
						</div>
...
var updateExhibitHelper = {
		
	init : function () {
		var me = updateExhibitHelper;
	...
	provinceChange : function () {
		...
		var defaultCityId = $("#defaultCityId").val();
					...
					if (data.resultCode != '0000') {
						...
						if (data.data.length > 0) {
							...
							$.each(data.data, function(index, entity) {
								if(defaultCityId == entity.areaId) {
									$("#cityId").append(
											'<option selected = "selected" value="' + entity.areaId + '" data-id="' 
													+ entity.areaId + '" data-name="'+ entity.areaName +'">'
													+ entity.areaName
													+ '</option>');//赋值
								} else {
									$("#cityId").append(
...
$(function(){
	updateExhibitHelper.init();
	var provinceId = ${exhibit.parentId};
	$("#provinceId").val(provinceId);
	updateExhibitHelper.provinceChange();
});
...
function saveExhibit() {
	...
	$.ajax({
		url : "${basePath}/exhibit/updateSaveExhibit.do",
		data : param,
		dataType: "json",
		type : "POST",
		success : function(data) {
