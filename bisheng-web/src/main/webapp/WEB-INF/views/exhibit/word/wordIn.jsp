				...
				<div class="table-toolbar">
					...
					<form id='filter_form' href="##" method="post">
						...
						<div class="form-group input-inline">
							...
							入库日期:
							<input class="form-control input-inline input-sm date-picker" id="inDateStrMin" name="inDateStrMin"
								   size="10" type="text" data-date-format="yyyy-mm-dd" placeholder="开始日期"/>
							至:
							<input class="form-control input-inline input-sm date-picker" id="inDateStrMax" name="inDateStrMax"
